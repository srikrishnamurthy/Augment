...
- (void)viewDidLoad {
    ...
    overlay.image = [UIImage imageNamed:@"kenko-gradient.png"];
    overlay.layer.opacity = 0.65;
...
//    [self.view addSubview:overlay2];
    ...
    title.font = [UIFont fontWithName:@"Hybrea" size:50];
...
-(void) takePhoto
{
    GuController* vc = [[GuController alloc] init];
